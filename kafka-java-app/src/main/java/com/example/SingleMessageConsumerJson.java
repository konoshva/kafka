...
public class SingleMessageConsumerJson {
...
//        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka1:9092");  // Адрес брокера Kafka
        ...
        props.put(KafkaJsonSchemaDeserializerConfig.SCHEMA_REGISTRY_URL_CONFIG,
                "http://localhost:8081");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG,
                StringDeserializer.class.getName());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
                KafkaJsonSchemaDeserializer.class.getName());
        props.put(KafkaJsonSchemaDeserializerConfig.JSON_VALUE_TYPE, "com.example.SingleMessageConsumerJson$Product");
